...
void KICKER::enable_charge() { _charge = 0; }

void KICKER::disable_charge() { _charge = 1; }
...
void KICKER::kick1(float power) {
    ...
    _kick1_timeout.attach(callback(this, &KICKER::kick1_off),
                          std::chrono::microseconds((int)(power * 10000.0)));
}
...
void KICKER::kick2(float power) {
    ...
    _kick2_timeout.attach(callback(this, &KICKER::kick2_off),
                          std::chrono::microseconds((int)(power * 10000.0)));
}
...
void KICKER::set_kick1_available() { _kick1_available = true; }

void KICKER::set_kick2_available() { _kick2_available = true; }
